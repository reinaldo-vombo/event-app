...
const Pill = () => {
   ...
   const items = [
      ...
      },
      {
         ...
         icon: NotepadText,
         text: "Details",
         description: "7 estão interessado",
         color: "#00CB48",
         bg: "#001E0B",
      },
      {
   ...
   return (
      <div className="w-full h-full flex items-center justify-center dark:bg-black bg-white rounded-xl p-2">
