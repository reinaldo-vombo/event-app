               ...
               <ExpandabelCard title="Comprar bilhet">
                  ...
                  <div className="mb-6 space-y-5">
                     {props.price.map((ticket) => (
                        <div className='flex justify-between border border-gray-700 cursor-pointer hover:bg-slate-400 p-1 rounded-md' key={ticket.title} onClick={() => handleSelectPrice(ticket.price)}>
